...
const {
  arrayOf, bool, object, func, shape, string
} = PropTypes
...
const callLoadData = (props) => {
  const {
    match, location, route, dispatch, logoutInProgress
  } = props
...
class RouteComponentRenderer extends Component {
  ...
  render() {
    const {
      route, match, location, staticContext
    } = this.props
...
const Routes = (props, context) => {
  const {
    isAuthenticated, logoutInProgress, staticContext, dispatch, routes
  } = props
