...
export const bookingProductRequired = (inValidDateMessage) => (value, allValues) => {
  console.log(allValues)
  const productIsValid = value && value.bookingProduct === typeof String
  return !productIsValid ? 'Booking product required' : VALID
}
...
export const composeValidators = (...validators) => (value, allValues) => validators.reduce((error, validator) => error || validator(value, allValues), VALID)
