...
const SectionTypeMaybe = props => {
  ...
  const selectedOption =
    publicData && publicData.type ? publicData.type : null;

  // Don't return anything if public data doesn't contain type field
  // That's why we named this component as SectionTypeMaybe
  ...
  return (
    <div className={css.sectionFeatures}>
      <h2>
        <FormattedMessage
          id="ListingPage.type"
          values={{ type: optionLabel.toLowerCase() }}
        />
      </h2>
    </div>
  );
