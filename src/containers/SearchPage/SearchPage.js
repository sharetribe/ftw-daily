...
import {
  array, bool, func, number, oneOf, object, shape, string
} from 'prop-types'
...
SearchPage.loadData = (params, search) => {
  ...
  return searchListings({
    ...
    'fields.listing': ['title', 'geolocation', 'price', 'publicData.products'],
