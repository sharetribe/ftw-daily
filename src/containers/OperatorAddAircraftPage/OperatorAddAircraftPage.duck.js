...
export const FETCH_LISTINGS_REQUEST = 'app/OperatorAddAircraftPage/FETCH_LISTINGS_REQUEST';
export const FETCH_LISTINGS_SUCCESS = 'app/OperatorAddAircraftPage/FETCH_LISTINGS_SUCCESS';
export const FETCH_LISTINGS_ERROR = 'app/OperatorAddAircraftPage/FETCH_LISTINGS_ERROR';

export const OPEN_LISTING_REQUEST = 'app/OperatorAddAircraftPage/OPEN_LISTING_REQUEST';
export const OPEN_LISTING_SUCCESS = 'app/OperatorAddAircraftPage/OPEN_LISTING_SUCCESS';
export const OPEN_LISTING_ERROR = 'app/OperatorAddAircraftPage/OPEN_LISTING_ERROR';

export const CLOSE_LISTING_REQUEST = 'app/OperatorAddAircraftPage/CLOSE_LISTING_REQUEST';
export const CLOSE_LISTING_SUCCESS = 'app/OperatorAddAircraftPage/CLOSE_LISTING_SUCCESS';
export const CLOSE_LISTING_ERROR = 'app/OperatorAddAircraftPage/CLOSE_LISTING_ERROR';

export const ADD_OWN_ENTITIES = 'app/OperatorAddAircraftPage/ADD_OWN_ENTITIES';
...
const OperatorAddAircraftPageReducer = (state = initialState, action = {}) => {
...
export default OperatorAddAircraftPageReducer;
...
export const getOwnListingsById = (state, listingIds) => {
  const { ownEntities } = state.OperatorAddAircraftPage;
