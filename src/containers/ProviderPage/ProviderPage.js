...
import { ASSET_NAME } from './ProviderPage.duck';
...
const PrivacyPolicyPage = compose(connect(mapStateToProps))(ProviderPageComponent);

const PROVIDER_PAGE_ASSET_NAME = ASSET_NAME;
export { PROVIDER_PAGE_ASSET_NAME, ProviderPageComponent, ProviderContent };
