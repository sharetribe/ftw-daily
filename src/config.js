...
const bookingProcessAlias = process.env.REACT_PROCESS_ALIAS || "preauth-with-nightly-booking/release-1";
...
const bookingUnitType = process.env.REACT_APP_BOOKING_UNIT_TYPE || "line-item/night";
