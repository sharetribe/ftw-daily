...
const TermsOfService = props => {
  ...
  return (
    <div className={classes}>
      ...
      <p>
        JamInTime is an online marketplace that allows you to discover and book music studios and also offer your music studio to artists. Please read our service agreement carefully below prior to using our marketplace and it’s services as it governs your use of our platform.
      </p>
      ...
      <p>
        This JamInTime Services Agreement (“Agreement”) is a contract between JamInTime, LLC. (“JamInTime” or “we”) and the person(s) that are registered with JamInTime (“user” or “you”). This Agreement describes the terms and conditions that apply to your use of the JamInTime marketplace to book or list studios or other studio services through our website or apps, and governs your studio for other users; and establishes the obligations owed between you and JamInTime, and between you and other users.
      </p>
      ...
      <p>
        ...
        <ol>
          <li type="disc"><p><strong>Section 1: General Terms</strong> includes general terms describing your Account including creating an account, accepting or making payments, and describing how we communicate with you.</p></li>
          <li type="disc"><p><strong>Section 2: Platform and Service</strong> describes how you may and may not use the Platform and Service, and also describes how we use any data.</p></li>
          <li type="disc"><p><strong>Section 3: JamInTime Services</strong> establishes the obligations of Studios, including how to List a Studio and what is expected of any Studio Listed through the Service; and the obligations of Artists, including Booking a Studio, expected behavior, responsibility for payment of Fees, and Booking other services.</p></li>
          <li type="disc"><p><strong>Section 4: Termination, Disputes, and Binding Arbitration</strong> describes termination or suspension of this Agreement or your Account, and the process of resolving any disputes. <strong>This section contains waivers of both class actions and jury trials, and an agreement to submit all claims and disputes to binding arbitration. Please read this section carefully before accepting this Agreement –you may not use the Platform or Services if you do not agree to this section.</strong></p></li>
          <li type="disc"><p><strong>Section 5: Additional Legal Terms</strong> provides additional legal terms including our ability to update this Agreement, disclaimers and limitations on our liability, and some specific terms for users outside of the United States. It also includes other documents governing your use of the Services including our Community Guidelines, Fees, Privacy Policy, and Cancellation and Refund Policy.</p></li>
        </ol>
      <p>
        If you have questions about this Agreement, please contact us at info@audiobarn.ca Your use of the Platform or Services constitutes your ongoing acceptance of this Agreement, as amended.
      </p>

      <h2>Section 1: General Terms</h2>
      <h3>1.1 Services</h3>
      <p>
      JamInTime provides you access to Services through the Platform. You may access the Platform through our website or apps. You may use the Service to List Studios, Book Studios as an Artist, communicate with other users, and access your Account.
You may also be permitted to Book Studio Services (“Studio Services”) through third-party service providers or through the Studio, which may require you to agree to additional terms or conditions. These Studio Services may include Audio Engineering, Production, or other Services that can take place in the Studios. This is however not the main marketplace Service provided by JamInTime.
...
At our sole option, we may suspend or terminate your Account.
      ...
      <h3>1.4 Fees and Taxes</h3>
        <p>
          (a) Fees, Overtime. You are responsible for payment of fees, expenses, and other amounts related a to Booking (“Fees”). Fees include amounts paid to JamInTime, Studios, and Studio Services and as described in our Fees Overview. JamInTime receives Fees for providing use of the Service, and Studios receive Fees for Bookings. The specific Fees charged are presented when you request, complete, and pay for a Booking. Please review the Studios individually listed cancellation policy on their Listing prior to submitting a Booking request. You should contact Studios through the Platform before Booking if you don’t understand the Fees listed or their cancellation policy that will be applicable. Please email us at info@audiobarn.ca at any time if you do not understand Fees or have questions regarding them.
        </p>
        <p>
      ...
      <h3>1.5 Receiving Payment</h3>
        ...
        <h3>1.6 Communication and Notices</h3>
        <p>
        ...
        <p>
          We may send you notices to the email address or physical address included in your Account, through messaging on the Platform. You may send any notices to us at info@audiobarn.ca . You agree that any email notice from us is considered accepted by you one day after such notice was sent and will have the same legal effect as if it were physically delivered to you.
        </p>
        <p>
        ...
        <p>
          If you have problems communicating receiving messages, please first please contact us at info@audiobarn.ca.
        </p>
      
      <h3>1.7 Communication with Other Users</h3>
        <p>
      ...
      <h3>2.3 Content</h3>
        ...
        <p>
          <strong>(c) DMCA Notices.</strong> If you believe that any Content posted violates your copyright, please notify us at info@audiobarn.ca. This notice should identify the specific Content and provide us with evidence of your ownership of the copyright or authorization to enforce the rights of the copyright owner. Any information you provide to us may be shared with other users, third parties, or law enforcement to help assess the claim of infringement or remove infringing content. We will remove any content we determine to be infringing consistent with our obligations under the Digital Millennium Copyright Act (DMCA).
        </p>

      
      <h3>2.4 Privacy and Data Usage</h3>
        <p>
      ...
      <h2>3 JamInTime Services</h2>
      <h3>3.1 Listing Studios - This section applies to Studios</h3>
        <p>
          <strong>(a) Listings.</strong> When you List a Studio, you must provide details about the Space including a description, the cost of a Booking, a list of equipment, current pictures, and other details about its potential uses and condition (collectively, “Description”). While it is important to communicate the benefits of your Studio, the Description must be accurate and give potential Artists a reasonably good understanding of how they may use the Studio for their Booking. Descriptions may not include any additional contractual obligations or alter Artists legal liabilities from those described in this Agreement.
        </p>
        <p>
          <strong>(b) Transacting with Artists.</strong> All Studios must comply with our Community Guidelines when Listing a Studio, providing a Description, and in transacting with Artists. You are responsible for maintaining the Studio and Studio Services so that Artists may reasonably use them as provided in the Description and Booking. Studios must be in good working order and provided to Artists in a safe, clean and usable condition as described.        
        </p>
        <p>
          <strong>(c) Conduct and Fees.</strong> As a Studio, you are solely responsible for ensuring that Studio complies with all applicable Laws including any local ordinances related to the condition, licensure, or registration Studios for use by Artists, and payment of Taxes. We may condition your continued use of the Platform and Services on your providing proof, to our reasonable satisfaction, of your compliance with Laws at any time.        
        </p>
      
      <h3>3.2 Booking STudios and Studio Services - This applies to Artists</h3>
        <p>
          <strong>(a) Bookings.</strong> As an Artist, you should review the Description and availability to confirm they are appropriate for your Booking. The Platform allows you to confirm any details or ask the Studio any specific questions about the Studio or Studio Services, or confirm details of a Booking, without sharing your personal contact information. Prior to Booking, you will need to provide payment information through the Platform. Booking Fees will be shown before you complete your Booking. You are responsible for all Fees and Taxes associated with the Booking. All Bookings are subject to the Cancellation Policy listed on each individual Studio Listing.
        </p>
        <p>
      ...
      <h3>3.3 Required and Supplemental Insurance</h3>
        <p>
          <strong>(a) Required Insurance.</strong> Every user will acquire and maintain all insurance as required by Law and suitable for you or your business. You are solely responsible for understanding and evaluating what insurance is appropriate to cover damage, loss, injury, legal liability, and other harm specific to you, your business, those attending the Booking, third parties, the Studio, and deciding what coverage, limits and providers are appropriate for you.
        </p>
      
      <h3>3.4 Cancellations and Refunds</h3>
        <p>
          All cancellations and any refunds that may be available to you are subject to our Fees and all cancellations are subject to the JamInTime Cancellation Policy, in addition to any individual studio Cancellation Policy as identified on each individual Studios Listing. JamInTime is not liable for any fees, expenses, or liability that is not in compliance with the Cancellation Policy for a Listing.
        </p>

      <h2>4 Termination, Disputes, and Binding Arbitration</h2>   
      <h3>4.1 Term, Termination, and Survival</h3>
        <p>
        ...
        <p>
          <strong>(b) Suspension or Termination by JamInTime.</strong> We may suspend your Account--including your ability to communicate with other users or receive payments, or complete a Booking--or terminate this Agreement and your Account at any time including, without limitation, (i) if we believe that use of your Account poses a risk to JamInTime, you, other users, or third parties, (ii) actual or potential fraud by you or on your behalf, (iii) your failure to respond to communications from us or other users, or (iv) your failure to comply with this Agreement or applicable Law.        
        </p>
        <p>
      ...
      <h3>4.2 Binding Arbitration</h3>
        <p>
          <strong>This section describes how disputes or claims arising under this Agreement between you and JamInTime or between you and another user (not resolved through the process set forth in Section 4.3) will be resolved. It includes waivers to both a jury trial and your ability to join other plaintiffs as part of a class action. Please read this section carefully before accepting this Agreement—you may not use the Platform or Services if you do not agree to this section.</strong>
        </p>
        <p>
          <strong>(a) Process for Arbitration.</strong> Subject to the exclusions provided in Section 4.2(b) and the process provided in Section 4.3, all disputes, claims, and controversies arising under or related to this Agreement between you and JamInTime or between you and another user (if not resolved pursuant to Section 4.3 below) will be resolved through binding arbitration as follows:
        </p>
        <ol>
          <li type="disc"><p>(i) if the amount of the dispute, claim, or controversy is reasonably less than $25,000, resolution shall be administered online by FairClaims (www.fairclaims.com) or another online arbitration provider of our choosing in accordance with their applicable arbitration rules and procedures effective at the time a claim is made. You consent to receive electronic service of process at the email associated with your Account. Where you are delinquent in responding to such process, you will be responsible for any attorney, court, or other fees associated with the delinquency. The party filing the User Dispute will be responsible for payment of any costs associated with that filing, including costs borne by JamInTime. As a part of the User Dispute, you may also seek to recover these costs if you prevail.</p></li>
          <li type="disc"><p> (ii) if the amount of the dispute, claim or controversy is reasonably $25,000 or more, resolution shall be before a single arbitrator and administered by JAMS. This includes but is not limited to any statutory or common law claims relating to breach, enforcement, or interpretation of this Agreement and any Booking Agreement. Any such arbitration will take place in the county where the Booked or Listed Studio is located, unless you and JamInTime mutually agree otherwise. The arbitrator will apply the substantive Laws of California. All claims from $25,000 to $250,000 shall be subject to the JAMS Streamlined Arbitration Rules. The Federal Arbitration Act (9 U.S.C. §§ 1-16) will govern all such arbitrations under this Agreement. To initiate such an arbitration, a party will provide a written demand that states both the basis of the claim and the desired relief. Each party irrevocably and unconditionally consents to service of process through personal service at their corporate headquarters, registered address, or primary address (for individuals or sole proprietors). Nothing in this Agreement affects the right of any party to serve process in any other manner permitted by Law.</p></li>
        </ol>
        <p>
      ...
      <h3>4.3 Disputes Between users</h3>
        <p>
      ...
      <h2>5 Additional Legal Terms</h2>      
      <h3>5.1 Right to Amend</h3>
        <p>
      ...
      <h3>5.2 Cancellations</h3>
        <p>
          JamInTime is not responsible or liable for nonperformance caused by communication failures or nonperformance of Studios.
        </p>
        <p>
      ...
      <h3>5.6 Indemnities</h3>
        <p>
          You will indemnify, defend and hold JamInTime and its owner(s), agents, members, information providers, attorneys, or affiliates (collectively, “JamInTime Affiliates”) harmless against all third-party claims, liabilities, losses, damages, and related expenses (including reasonable legal expenses) (collectively, “Claims”) arising from or related to (a) provision of your Studio (for Studios) or Studio Service (for Studios), or use of Studios or Studio Services (for Artists); (b) Content you provide through the Platform; (c) your failure to comply with Laws; (d) your providing of information to us that is inaccurate or incomplete, (e) your breach of any of your obligations under this Agreement, and (f) any contract or other agreement between you and any other user other than through the Platform. This indemnification will survive termination of this Agreement.
        </p>

      <h3>5.7 Limitations of Liability</h3>
        <p>
          EXCEPT TO THE LIMITED EXTENT OF THE JamInTime FEES (AS DEFINED BELOW) UNDER NO CIRCUMSTANCES OR ANY LEGAL THEORY WILL JamInTime OR ITS OWNERS, AGENTS, MEMBERS, INFORMATION PROVIDERS, ATTORNEYS, OR AFFILIATES BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DAMAGES (WHETHER DIRECT, INDIRECT, GENERAL, COMPENSATORY, INCIDENTAL, CONSEQUENTIAL, SPECIAL, PUNITIVE, EXEMPLARY OR OTHERWISE), INJURY, CLAIM OR LIABILITY OF ANY KIND OR CHARACTER BASED UPON OR ARISING FROM YOUR USE OF OR INABILITY TO USE THE PLATFORM OR SERVICES, OR STUDIOS OR STUDIO SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF DAMAGES. IF YOU ARE DISSATISFIED WITH THE PLATFORM OR SERVICES, OR ANY CONTENT CONTAINED THEREIN, YOUR SOLE AND EXCLUSIVE REMEDY IS TO DISCONTINUE USING THE PLATFORM AND SERVICES.
        </p>
        <p>
          AS USED HEREIN, “JamInTime FEES” SHALL MEAN THE AMOUNT PAID BY YOU TO JamInTime, EXCLUDING ANY AMOUNTS THAT WERE PAID OR PAYABLE TO STUDIOS OR STUDIO SERVICES, FOR USE OF THE PLATFORM OR SERVICES.
        </p>
        <p>
          THE LIMITATION OF LIABILITY SET FORTH ABOVE APPLIES TO THE EXTENT PERMITTED BY LAW.
        </p>
      
      <h3>5.8 Additional Terms for Users Outside Canada</h3>
        <p>
      ...
      <h3>5.9 Antire Agreement; Interpretation</h3>
        <p>
          This Agreement together with any Booking Agreement constitutes the entire agreement between you and JamInTime governing your use of the Platform or Services. This Agreement supersedes all prior understandings or agreements between you and JamInTime. As between you and JamInTime, this Agreement controls over any conflicting terms in a Booking Agreement except where expressly stated otherwise and agreed upon in writing between the parties.
        </p>
        <p>
