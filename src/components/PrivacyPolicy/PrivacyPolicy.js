  ...
  return (
    <div className={classes}>
      ...
      <div className="{css.policyContainer}">
        ...
        <p>You can always choose to enable or disable cookies in your internet browser. By default, most internet browsers accept cookies but this can be changed. For further details, please consult the help menu in your internet browser. For further information about cookies, please see: www.allaboutcookies.org, and how to adjust your browser settings here: <a href="www.allaboutcookies.org/managecookies">www.allaboutcookies.org/managecookies</a>. </p>
